<?php
	...
	/* Fonction qui permet de compter le numижro journalier des produit mauvais pour la machine sижlectionnижe */
	/* Entre  : jour d'aujourd'hui, machine sижlectionnижe																										*/
	/* Sortie : nombre des dижfauts pour cette machine pendant la journижe																		*/
	...
	/* Fonction qui permet de compter le numижro journalier des produit mauvais pour toutes les machines			*/
	/* Entre  : jour d'aujourd'hui																																					*/
	/* Sortie : nombre des dижfauts pour toutes les machines pendant la journижe															*/
	...
	/* Fonction permettante de calculer le parижto d'un dижfaut pour la machine sижletionnижe										*/
	/* Entre  : defaut, nombre des dижfauts pour toutes les machines																					*/
	/* Sortie : pourcetage pour ce dижfaut journalier																												*/
